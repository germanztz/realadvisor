...
class TestScraper(unittest.TestCase):
    ...
    def test_parse_list_idealista(self):
        scraper = Scraper()
        content = open('tests/idealista_lista.html', 'r').read()
    ...
    def test_parse_item_idealista(self):
        scraper = Scraper()
        content = open('tests/idealista_detalle.html', 'r').read()
        content = Scraper.CLEAN_RX.sub('', content)
    ...
    def test_parse_list_fotocasa(self):
        scraper = Scraper()
        content = open('tests/fotocasa_lista.html', 'r').read()
        content = Scraper.CLEAN_RX.sub('', content)
    ...
    def test_parse_item_fotocasa(self):
        scraper = Scraper()
        content = open('tests/fotocasa_detalle.html', 'r').read()
        content = Scraper.CLEAN_RX.sub('', content)
